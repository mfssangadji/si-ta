...
<?php $__env->startSection('content'); ?>
		...
		<?php if($sesi->status == 0): ?>
			<?php if(Auth::guard('dosen')): ?>
				<form method="post" action="<?php echo e(url('bimbingan-dosen/'.Request::segment(2).'/'.Request::segment(3).'/konsultasi/confirm')); ?>" style="display:inline;">
					<?php echo csrf_field(); ?>
					<button type="submit" style="width:100%" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin mengubah status sesi konsultasi ini?')">Tekan Tombol ini Jika Selesai</button>
				</form>
			<?php endif; ?>
		<?php endif; ?>
						...
						<div class="block_content">
							...
							<p class="excerpt">
								...
								<?php if($k->lampiran != ""): ?>
									...
									<a target="_blank" href="<?php echo e(url('bimbingan-dosen/'.Request::segment(2).'/'.Request::segment(3).'/konsultasi/'.$k->id)); ?>" style='color:#FFF'>Download Lampiran</a>
									</span>
								<?php endif; ?>
							</p>
						</div>
		...
		<?php if($sesi->status == 0): ?>
			<form id="demo-form2" method="post" action="<?php echo e(url('bimbingan-dosen/'.Request::segment(2).'/'.Request::segment(3).'/konsultasi')); ?>" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('webpanel.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\si-ta\resources\views/webpanel/bimbingan/dosen/sesi/konsultasi/index.blade.php ENDPATH**/ ?>